...
class Sabitler {
  static final TextStyle baslikStyle =
      GoogleFonts.quicksand(fontWeight: FontWeight.w900);

  static final TextStyle DrawerStyle =
      GoogleFonts.quicksand(fontWeight: FontWeight.w900,color: Colors.white);

   static final TextStyle DrawerbaslikSiyah =
      GoogleFonts.quicksand(fontWeight:FontWeight.w500, color: Colors.black87);

  static final TextStyle detayStyle =
      GoogleFonts.quicksand(
        fontWeight: FontWeight.w700,
        fontSize: 20);

  static final TextStyle baslikSiyah =
      GoogleFonts.quicksand(fontWeight: FontWeight.w900, color: Colors.black87);
  ...
  static final TextStyle CardStyle =
   ...
   static final TextStyle aciklamaBaslik =
      GoogleFonts.quicksand(fontSize: 18,fontWeight: FontWeight.w600 ,color: Colors.white);
